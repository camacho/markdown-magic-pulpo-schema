> **📦 This package has moved.** It now lives in the [markdown-magic-plugins](https://github.com/camacho/markdown-magic-plugins) monorepo at [`packages/pulpo-schema`](https://github.com/camacho/markdown-magic-plugins/tree/main/packages/pulpo-schema). This repository is archived; issues and contributions go to the monorepo.
